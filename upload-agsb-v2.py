...
def generate_links(domain, port_vm_ws, uuid_str):
    ...
    logging.info("\033[36m╭───────────────────────────────────────────────────────────────╮\033[0m")
    logging.info("\033[36m│                \033[33m✨ ArgoSB 安装成功! ✨                    \033[36m│\033[0m")
    logging.info("\033[36m├───────────────────────────────────────────────────────────────┤\033[0m")
    logging.info(f"\033[36m│ \033[32m域名 (Domain): \033[0m{domain}")
    logging.info(f"\033[36m│ \033[32mUUID: \033[0m{uuid_str}")
    logging.info(f"\033[36m│ \033[32m本地Vmess端口 (Local VMess Port): \033[0m{port_vm_ws}")
    logging.info(f"\033[36m│ \033[32mWebSocket路径 (WS Path): \033[0m{ws_path_full}")
    logging.info("\033[36m├───────────────────────────────────────────────────────────────┤\033[0m")
    logging.info("\033[36m│ \033[33m所有节点链接 (带格式):\033[0m") # 标题
    ...
    logging.info("\033[36m├───────────────────────────────────────────────────────────────┤\033[0m")
    logging.info(f"\033[36m│ \033[32m详细节点信息及操作指南已保存到: \033[0m{LIST_FILE}")
    logging.info(f"\033[36m│ \033[32m单行节点列表 (纯链接) 已保存到: \033[0m{INSTALL_DIR / 'allnodes.txt'}")
    logging.info("\033[36m│ \033[32m使用 \033[33mpython3 " + os.path.basename(__file__) + " status\033[32m 查看详细状态和节点\033[0m")
    logging.info("\033[36m│ \033[32m使用 \033[33mpython3 " + os.path.basename(__file__) + " cat\033[32m 查看所有单行节点\033[0m")
    logging.info("\033[36m│ \033[32m使用 \033[33mpython3 " + os.path.basename(__file__) + " del\033[32m 删除所有节点\033[0m")
    logging.info("\033[36m╰───────────────────────────────────────────────────────────────╯\033[0m")
